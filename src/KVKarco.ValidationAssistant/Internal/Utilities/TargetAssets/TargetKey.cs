...
/// </summary>
internal sealed class TargetKey
{
    /// <summary>
    /// Represents an empty or default <see cref="TargetKey"/> instance.
    /// This is typically used when no specific property is being referenced,
    /// such as for root-level validation or initialization.
    /// </summary>
    public static readonly TargetKey Empty = new(null!, string.Empty, false);
    ...
    private TargetKey(MemberInfo? propertyInfo, string propertyPath, bool isForCollection)
    {
        Info = propertyInfo;
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="TargetKey"/> class.
    /// This is the recommended way to instantiate <see cref="TargetKey"/> objects.
    /// </summary>
    ...
    /// <param name="isForCollection">A boolean indicating whether this property represents a collection type.</param>
    /// <returns>A new <see cref="TargetKey"/> instance.</returns>
    public static TargetKey Create(MemberInfo propertyInfo, string propertyPath, bool isForCollection)
    {
        // Null-forgiving operators used assuming non-null inputs for Create based on usage context.
        return new TargetKey(propertyInfo, propertyPath, isForCollection);
    }
